<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/admin\view\science\lok.html";i:1562638766;s:81:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/admin\view\common\top.html";i:1562579651;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/admin\view\common\left.html";i:1562579316;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                ...
                                <div class="flip-scroll">
                                    <form role="form" action="" enctype="multipart/form-data" method="post">
                                        <table class="table table-bordered table-hover">
                                            <input type="hidden" name="id" value="<?php echo $science['id']; ?>">
                                            <tr>
                                                <th class="text-center" colspan="2">技术视频</th>
                                            </tr>
                                            <tr>
                                                <td align="center">
                                                    <div>
                                                        <h6>视频展示图：</h6>
                                                        <input id="poster" placeholder="" name="poster" style="display:inline;"   type="file">
                                                    </div>
                                                    <div>
                                                        <input type="hidden" name="poster" value="<?php echo $science['poster']; ?>">
                                                        <?php if($science['poster'] != 'img/'): ?>
                                                        <img src="__IMG__/index/<?php echo $science['poster']; ?>" height="100" width="200">
                                                        <?php else: ?>
                                                        暂无缩略图，请选择！
                                                        <?php endif; ?>
                                                    </div>
                                                ...
                                                <td align="center">
                                                    <div>
                                                        ...
                                                        <input type="hidden" name="video" value="<?php echo $science['video']; ?>">
                                                    </div>
                                                    <div>
                                                        <?php if($science['video'] != 'video/'): ?>
                                                        <video width="200" height="100" controls="controls">
                                                            <source src="__IMG__/index/<?php echo $science['video']; ?>" type="video/mp4">
                                                        </video>
                                                        <?php else: ?>
                                                        暂无视频，请选择！
                                                        <?php endif; ?>
                                            ...
                                            <tr>
                                                <td align="center" colspan="2">
                                                    <label>
                                                        <textarea name="content" id="content"><?php echo $science['content']; ?></textarea>
                                                    </label>
                                                </td>
                                            </tr>
                                            <tr>
