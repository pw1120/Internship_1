<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:88:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\index\productpage.html";i:1562136786;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\nav.html";i:1562053856;s:85:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\footer.html";i:1562118186;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="menu animated">
    ...
    <section class="main">
        <div class="padding">
            <?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$da): $mod = ($i % 2 );++$i;?>{da.h1}
            <h1 class="title"></h1>
            <div class="video">
                <video poster="__PUBLIC__/{da.video_img}" controls="">
                    <source src="__PUBLIC__/{da.video}" type="video/mp4">
                </video>
            </div>
