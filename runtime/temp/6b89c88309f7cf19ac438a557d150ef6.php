<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\index\about.html";i:1562548726;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\nav.html";i:1562053856;s:85:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\footer.html";i:1562118186;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <section class="main">
        <div class="padding">
            <div class="subnavigation flex">
                <a href="about.html" class="cur">公司简介</a>
                <a href="join.html">加入我们</a>
            </div>
            <div class="editor-box">
                <?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$da): $mod = ($i % 2 );++$i;?><?php echo $da['content']; endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
    </section>
