<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/admin\view\test\test1.html";i:1562736162;s:81:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/admin\view\common\top.html";i:1562579652;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/admin\view\common\left.html";i:1562735946;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                            ...
                            <div class="widget-body">
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
                                        <input type="hidden" name="id" value="<?php echo $test1['id']; ?>">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="hidden" name="img" value="<?php echo $test1['img']; ?>">
                                                <?php if($test1['img'] != ''): ?>
                                                <img src="__IMG__/<?php echo $test1['img']; ?>" height="50" width="100">
                                                <?php else: ?>
                                                暂无缩略图，请选择！
                                                <?php endif; ?>
                                            </div>
                                            <button type="button" class="btn btn-default" onClick="warning('确实要删除吗', '<?php echo url('test/del',array('id'=>$test1['id'])); ?>')">
                                                删除图片
                                            </button>
                                        </div>
                                        <div class="form-group">
