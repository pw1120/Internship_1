<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\index\case_page.html";i:1562549359;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\nav.html";i:1562053856;s:85:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\footer.html";i:1562118186;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="menu animated">
    ...
    <section class="main">
       ...
       <div class="padding">
        <h1 class="title science-title"><?php echo $da['title']; ?></h1>
            <div class="editor-box">
            <p><img src="__PUBLIC__/<?php echo $da['img_url']; ?>" alt=""></p>
                <?php echo $da['content']; ?>
            </div>
        </div>
