<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\index\case.html";i:1562549335;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\nav.html";i:1562053856;s:85:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\footer.html";i:1562118186;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="menu animated">
    ...
    <section class="main">
        <div class="padding">
            <ul class="product-list case-list">
                ...
                <li>
                    <a href="<?php echo url('case_page',array('id'=>$da['id'])); ?>">
                        <h3><?php echo $da['title']; ?></h3>
                        <p><?php echo $da['translate']; ?></p>
                    </a>
                    <img src="__PUBLIC__/<?php echo $da['bg_url']; ?>" alt="机器人毛刺清理工具">
                </li>
