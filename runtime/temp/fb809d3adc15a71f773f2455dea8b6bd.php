<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/admin\view\test\test.html";i:1562729161;s:81:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/admin\view\common\top.html";i:1562579651;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/admin\view\common\left.html";i:1562721560;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
...
<div class="main-container container-fluid">
    ...
    <ul class="nav sidebar-menu">
        ...
        <li>
            <a href="<?php echo url('test/test'); ?>" class="menu-dropdown">
                    ...
                    <div class="col-lg-12 col-sm-12 col-xs-12">
                        <div class="widget">
                            <div class="widget-header bordered-bottom bordered-blue">
                                <span class="widget-caption">测试信息</span>
                            </div>
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" enctype="multipart/form-data" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="img" class="col-sm-2 control-label no-padding-right">标题背景图</label>
                                            <div class="col-sm-6">
                                                <input id="img" placeholder="" name="img" style="display:inline;"  type="file">
                                                <input type="hidden" name="img" value="<?php echo $test['img']; ?>">
                                                <?php if($test['img'] != ''): ?>
                                                <img src="__IMG__/<?php echo $test['img']; ?>" height="50" width="100">
                                                <?php else: ?>
                                                暂无缩略图，请选择！
                                                <?php endif; ?>
                                            </div>
                                            <button type="submit" name="de" value="del" class="btn btn-default" onClick="warning('确实要删除吗', '<?php echo url('test/del',array('id'=>$test['id'])); ?>')">
                                                删除图片
                                            </button>
                                        </div>
                                        <div class="form-group">
                                            <div class="col-sm-offset-2 col-sm-10">
                                                <button type="submit" name="de" value="edit" class="btn btn-default">
                                                    保存信息
                                                </button>
                                            </div>
                                        </div>
