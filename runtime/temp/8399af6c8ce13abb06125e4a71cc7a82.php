<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:87:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\index\exhibition.html";i:1562549690;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\nav.html";i:1562053856;s:85:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\footer.html";i:1562118186;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="menu animated">
    ...
    <section class="main">
        <div class="padding">
            <h1 class="title science-title">展会活动日历</h1>
            <div class="exhibition-list">
                <ul class="clearfix">
                    <li>
                        ...
                        <a href="<?php echo url('exhibition_page'); ?>">
                            <h3 class="omg"><?php echo $da['title']; ?></h3>
                            <time><?php echo $da['date']; ?></time>
                            <p><?php echo $da['place']; ?></p>
                        </a>
