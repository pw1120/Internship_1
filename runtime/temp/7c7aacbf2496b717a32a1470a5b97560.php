<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\index\science.html";i:1562550453;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\nav.html";i:1562053856;s:85:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\footer.html";i:1562118186;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <section class="main">
        <div class="padding">
            <div class="subnavigation flex">
                <a href="science.html" class="cur">专业术语</a>
                <a href="science_video.html">技术视频</a>
            </div>
            <div class="science-list">
               <ul>
                   ...
                   <li>
                       <a href="<?php echo url('science_page',array('id'=>$da['id'])); ?>">
                           <i class="s_right iconfont icon-xiangzuo-copy"></i><?php echo $da['title']; ?>
                       </a>
                   </li>
