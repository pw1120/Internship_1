<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\index\product_page.html";i:1562550295;s:82:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\nav.html";i:1562053856;s:85:"C:\phpStudy\PHPTutorial\WWW\test\public/../application/index\view\comment\footer.html";i:1562118186;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="menu animated">
    ...
    <section class="main">
        <div class="padding">
            <?php if(is_array($data) || $data instanceof \think\Collection): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$da): ?>
            <h1 class="title"><?php echo $da['title']; ?></h1>
            <div class="video">
                <video poster="__PUBLIC__/<?php echo $da['img_url']; ?>" controls="">
